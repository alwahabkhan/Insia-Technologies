      ...
      <div className="mx-auto max-w-[74rem]">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {results.map((result) => (
            ...
            >
              <p className='font-["ui-sans-serif,system-ui,sans-serif,\\"Apple_Color_Emoji\\",\\"Segoe_UI_Emoji\\",\\"Segoe_UI_Symbol\\",\\"Noto_Color_Emoji\\""] text-[60px] leading-[60px] font-bold text-[oklch(0.546_0.245_262.881)] transition-transform duration-200 group-hover:scale-[1.03]'>
                {result.value}
              </p>
              <p className='mt-4 font-["ui-sans-serif,system-ui,sans-serif,\\"Apple_Color_Emoji\\",\\"Segoe_UI_Emoji\\",\\"Segoe_UI_Symbol\\",\\"Noto_Color_Emoji\\""] text-[18px] leading-7 font-bold text-slate-900 transition-colors duration-200 group-hover:text-blue-600'>
                {result.title}
              </p>
        ...
        <div className="mt-12 rounded-3xl border border-[#BEDBFF] bg-[#F0F7FF] px-6 py-12 text-center shadow-[0_1px_0_rgba(15,23,42,0.04)] sm:px-8">
          <h3 className='font-["ui-sans-serif,system-ui,sans-serif,\\"Apple_Color_Emoji\\",\\"Segoe_UI_Emoji\\",\\"Segoe_UI_Symbol\\",\\"Noto_Color_Emoji\\""] text-[36px] leading-10 font-bold text-[oklch(0.208_0.042_265.755)]'>
            See your numbers improve
          </h3>
          <p className='mx-auto mt-4 max-w-3xl font-["ui-sans-serif,system-ui,sans-serif,\\"Apple_Color_Emoji\\",\\"Segoe_UI_Emoji\\",\\"Segoe_UI_Symbol\\",\\"Noto_Color_Emoji\\""] text-[18px] leading-7 font-normal text-[oklch(0.446_0.043_257.281)]'>
            Most teams see ROI in the first month. Track exactly how much time
            and money you're saving with built-in analytics.
          </p>
          <a
            href="#contact"
