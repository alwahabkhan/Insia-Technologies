      ...
      <div className="mx-auto max-w-[1200px]">
        <div className="grid grid-cols-2 gap-8 border-b border-white/10 pb-10 md:grid-cols-4">
          <div className="col-span-2 md:col-span-1">
            <h3 className={cn(textStyles.h2Dark, "text-3xl sm:text-4xl")}>INSIYA</h3>
            <p className={cn(textStyles.bodySmOnDark, "mt-3 max-w-[240px]")}>
              AI-powered data analytics platform for modern enterprises.
            </p>
          </div>

          <div>
            <h4 className={cn(textStyles.bodySm, "font-semibold text-white sm:text-[1.15rem]")}>
              Product
            </h4>
        ...
        <div className="mt-7 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          <p className={cn(textStyles.caption, "text-slate-400")}>
            &copy; 2026 INSIYA. All rights reserved.
          </p>
