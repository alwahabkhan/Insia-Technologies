    ...
    <section className="bg-[#F8FAFC] px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
      <div className="mx-auto max-w-[74rem]">
        <div className="text-center">
          ...
          <p className='mx-auto mt-4 max-w-3xl font-["ui-sans-serif,system-ui,sans-serif,\\"Apple_Color_Emoji\\",\\"Segoe_UI_Emoji\\",\\"Segoe_UI_Symbol\\",\\"Noto_Color_Emoji\\""] text-[20px] leading-7 font-normal text-[oklch(0.446_0.043_257.281)]'>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2">
          {securityCards.map((card) => (
            ...
            >
              <h3 className='font-["ui-sans-serif,system-ui,sans-serif,\\"Apple_Color_Emoji\\",\\"Segoe_UI_Emoji\\",\\"Segoe_UI_Symbol\\",\\"Noto_Color_Emoji\\""] text-[20px] leading-7 font-bold text-slate-900 transition-colors duration-200 group-hover:text-[oklch(0.546_0.245_262.881)]'>
                {card.title}
              </h3>
        ...
        <div className="mt-12 rounded-3xl border border-slate-200 bg-white px-8 py-10">
          <div className="grid gap-8 text-center sm:grid-cols-2 lg:grid-cols-4">
            {securityStats.map((item) => (
              <div key={item.value}>
                <p className='font-["ui-sans-serif,system-ui,sans-serif,\\"Apple_Color_Emoji\\",\\"Segoe_UI_Emoji\\",\\"Segoe_UI_Symbol\\",\\"Noto_Color_Emoji\\""] text-[30px] leading-9 font-bold text-[oklch(0.546_0.245_262.881)]'>
                  {item.value}
                </p>
